...
class SelectSchedulePage extends StatefulWidget {
  ...
  @override
  _SelectScehdulePageState createState() => _SelectScehdulePageState();
}

class _SelectScehdulePageState extends State<SelectSchedulePage> {
  List<DateTime> dates;
                          ...
                          context.read<PageBloc>().add(GoToSelectSeatPage(
                              Ticket(
                                  ...
                                  DateTime(
                                      ...
                                      selectedDate.day,
                                      selectedTime),
                                  //random string generator (id token)
                                  randomAlphaNumeric(12).toUpperCase(),
                                  null,
                                  //ambil user name harus ada blocbuilder UserBloc
