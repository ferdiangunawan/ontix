...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    super.initState();
    nameController = TextEditingController(text: widget.users.name);
    profilePath = widget.users.profilePicture;
  }

  @override
  Widget build(BuildContext context) {
    context.read<ThemeBloc>().add(
        //mengubah warna outline texfield
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      AbsorbPointer(
                        child: TextField(
                          controller:
                              TextEditingController(text: widget.users.id),
                          style:
                              whiteNumberFont.copyWith(color: accentColorGrey),
                      ...
                      TextField(
                        ...
                        onChanged: (text) {
                          setState(() {
                            isDataEdited = (text.trim() != widget.users.name ||
                                    profilePath != widget.users.profilePicture)
                                ? true
                                : false;
                          });
